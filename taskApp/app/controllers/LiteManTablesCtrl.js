angular.module('app').controller('LiteManTablesCtrl', LiteManTablesCtrl);

function LiteManTablesCtrl ($scope, $rootScope, $http, Globals, $localStorage, $location, $timeout){
  ...
  $scope.loadData = function(){
    ...
    $http.post(api_root + '/liteman/tables', data).success(function(data) {
